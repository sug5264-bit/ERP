    ...
    children: [
      ...
      { title: '단가관리', href: '/sales/pricing', permission: 'sales.pricing' },
      {
        ...
        children: [
          ...
          { title: '발주/출고 게시판', href: '/sales/3pl/orders/posts' },
    ...
    return (
      <Link
        ...
        className={cn(
          ...
          isActive
            ? 'bg-sidebar-primary text-sidebar-primary-foreground before:bg-sidebar-primary before:absolute before:top-1 before:bottom-1 before:left-0 before:w-[3px] before:rounded-full'
    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <CollapsibleTrigger
        className={cn(
          ...
          isActive
            ? 'bg-sidebar-accent text-sidebar-accent-foreground before:bg-sidebar-primary before:absolute before:top-1 before:bottom-1 before:left-0 before:w-[3px] before:rounded-full'
            : 'text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground'
        )}
      >
