...
export default function SalesPage() {
  ...
  const cards = [
    ...
    { title: '판매 거래처', value: `${partners?.meta?.totalCount || 0}개`, icon: Users, href: '/sales/partners' },
  ]

  const menus = [
    { title: '견적관리', desc: '고객 견적서 작성 및 관리', href: '/sales/quotations' },
    { title: '발주관리', desc: '발주 등록 및 관리', href: '/sales/orders' },
    { title: '납품관리', desc: '고객 납품 현황 관리', href: '/sales/deliveries' },
    { title: '거래처관리', desc: '고객 및 공급업체 관리', href: '/sales/partners' },
  ]

  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold tracking-tight">판매 모듈</h1>
